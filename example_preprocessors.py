...
from metadamagenet.dataset import LocalizationPreprocessor, ClassificationPreprocessor


class Preprocessors:
    DPN92_CLS = ClassificationPreprocessor(nn.Sequential(
        Random(VFlip(), p=0.5),
    ...
    RESNET34_CLS = ClassificationPreprocessor(nn.Sequential(
        Random(VFlip(), p=0.5),
    ...
    SERESNEXT50_CLS = ClassificationPreprocessor(nn.Sequential(
        Random(VFlip(), p=0.5),
    ...
    DPN92_LOC = LocalizationPreprocessor(nn.Sequential(
        Random(VFlip(), p=0.5),
        Random(Rotate90(), p=0.95),
    ...
    SENET154_LOC = LocalizationPreprocessor(nn.Sequential(
        Random(VFlip(), p=0.4),
    ...
    SERESNEXT50_LOC = LocalizationPreprocessor(nn.Sequential(
        Random(VFlip(), p=0.5),
        Random(Rotate90(), p=0.95),
        Random(Shift(), p=.1),
    ...
    DPN92_CLS_TUNE = ClassificationPreprocessor(nn.Sequential(
        Random(VFlip(), p=0.3),
    ...
    RESNET34_CLS_TUNE = ClassificationPreprocessor(nn.Sequential(
        Random(VFlip(), p=0.3),
        Random(Rotate90(), p=0.7),
        Random(Shift(), p=.02),
        Random(RotateAndScale(), p=0.5),
    ...
    SERESNEXT50_CLS_TUNE = ClassificationPreprocessor(nn.Sequential(
        Random(VFlip(), p=0.3),
        Random(Rotate90(), p=0.7),
        Random(Shift(), p=.01),
        Random(RotateAndScale(), p=0.5),
    ...
    DPN92_LOC_TUNE = LocalizationPreprocessor(nn.Sequential(
        Random(VFlip(), p=0.45),
        Random(Rotate90(), p=0.9),
        Random(Shift(), p=.05),
