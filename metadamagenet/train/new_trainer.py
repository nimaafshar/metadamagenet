...
from metadamagenet import models
...
class Trainer:
    ...
    def __init__(self,
        ...
        self._model_metadata: models.Metadata = model_metadata
    ...
    def _save_model(self, epochs_trained: int, score: float) -> None:
        metadata: models.Metadata = models.Metadata(best_score=score, trained_epochs=epochs_trained)
        checkpoint: models.Checkpoint = models.Checkpoint(
            model_name=self._wrapper.model_name,
            version=self._version,
            seed=self._seed
        )
        manager: models.Manager = models.Manager.get_instance()
